                  ...
                  <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                      ...
                      if(isset($_GET["name"])) {
                        ...
                        <div class='card'>
                            <div class='card-body'>
                                <h3 class='card-title'>". $res["companyName"] ."</h3>
                                <h6 class='card-subtitle mb-2 text-muted'>" . $res["symbol"] . "</h6>
                                <br><b>Open: </b>". $res["open"] . "
                                <br><b>Close: </b>". $res["close"] . "
                                <br><b>Latest Price: </b>". $res["latestPrice"] . "
                                <br><b>Change Percent: </b>". $res["changePercent"] . "
                                <br><b>Average Total Volume: </b>". $res["avgTotalVolume"] . "
                                <br><b>Latest Date: </b>". $res["latestTime"] . "
                            </div>
                        </div>";
                        ...
                        <br>Add to your Portfolio:
                      <form name="addtosub" method="get">
